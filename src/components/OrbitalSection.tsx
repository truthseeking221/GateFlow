...
export default function OrbitalSection() {
  ...
  return (
    <section className="min-h-[500px] flex flex-col pt-24 pb-24 relative bg-black border-y border-gray-800 font-sans overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-800 border border-gray-800 relative z-10">
