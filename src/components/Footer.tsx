...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-white/10 pt-16 pb-8 font-sans">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-16">
          ...
          <div className="md:col-span-4 flex flex-col items-start font-sans">
            ...
            <div className="mt-8 font-sans text-xs text-white/30 font-medium">
              System Version <span className="text-[#4ade80]">v8.0.0</span>
            </div>
          </div>
          ...
          {Object.entries(footerLinks).map(([title, links], i) => (
            <div key={title} className={`md:col-span-2 ${i === 0 ? 'md:col-start-7' : ''}`}>
              <h4 className="font-semibold text-white mb-6 text-sm">{title}</h4>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs font-medium text-white/30">
            &copy; {new Date().getFullYear()} GateFlow. All rights reserved.
          </p>
