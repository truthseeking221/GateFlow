...
export default function PricingSection() {
  ...
  return (
    <section id="pricing" ref={sectionRef} className="w-full relative bg-black font-sans border-b border-white/10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-24 pb-24 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 relative z-10 border-t border-l border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.8)]">
          {tiers.map((tier) => (
            <div
              key={tier.name}
              className="p-8 md:p-10 flex flex-col group relative bg-[#050505] border-b border-r border-white/10 transition-colors hover:bg-[#0a0a0a]"
            >
