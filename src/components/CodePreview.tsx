...
export default function CodePreview() {
  ...
  return (
    <section id="docs" ref={sectionRef} className="w-full relative bg-black font-sans border-b border-white/10 overflow-hidden">
      <canvas ref={canvasRef} className="absolute inset-0 w-full h-full pointer-events-none opacity-50 z-0 mix-blend-screen" />

      <div className="max-w-7xl mx-auto px-6 pb-24 pt-24 relative z-10">
        ...
        <div className="max-w-4xl mx-auto relative z-10 w-full">
          <div className="bg-[#050505] border border-white/10 rounded-xl overflow-hidden shadow-[0_4px_30px_rgba(0,0,0,0.8)] relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4">
              ...
              {/* Code block */}
              <div className="col-span-1 md:col-span-3 p-6 sm:p-8 bg-[#020202] overflow-x-auto h-[350px]">
