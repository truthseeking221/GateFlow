...
export default function ModelsCatalog() {
  ...
  return (
    <section id="models" ref={sectionRef} className="max-w-7xl mx-auto pt-24 px-6 pb-24 relative bg-black font-sans overflow-hidden">
      <canvas ref={canvasRef} className="absolute inset-0 w-full h-full pointer-events-none opacity-30 z-0 mix-blend-screen" />

      <div className="mb-24 flex flex-col items-start border-b border-gray-800 pb-12 relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 font-mono uppercase tracking-widest relative z-10">
